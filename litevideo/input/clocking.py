...
class S7Clocking(Module, AutoCSR):
    def __init__(self, pads, clkin_freq=148.5e6, split_clocking=False):
        ...
        self.clock_domains.cd_pix1p25x_r = ClockDomain()
        ...
        self.specials += [
            Instance("MMCME2_ADV",
                ...
                # and in according to the manual, OPTIMIZED == HIGH
                # VCO
        ...
        if split_clocking:
            ...
            self.specials += [
                ...
                Instance("BUFG", i_I=mmcm_clk2_o, o_O=self.cd_pix5x_o.clk), # can't be BUFIO because PLLE2 type can't drive BUFIO...
            ]
